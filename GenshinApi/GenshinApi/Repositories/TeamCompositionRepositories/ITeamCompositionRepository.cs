...
namespace GenshinApi.Repositories.TeamCompositionRepositories
{
    public interface ITeamCompositionRepository
    {
        ...
        Task<IEnumerable<TeamComposition>> GetAll();
        ...
        Task<TeamComposition> GetTeamById(int id);
        ...
        Task<int> CreateTeamComposition(TeamComposition teamComp);
        ...
        Task<bool> UpdateTeamComposition(int id, TeamComposition teamComp);
