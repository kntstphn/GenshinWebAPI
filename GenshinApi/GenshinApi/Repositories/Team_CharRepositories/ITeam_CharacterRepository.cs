...
{
    public interface ITeam_CharacterRepository
    {
        /// <summary>
        ...
        Task<TeamByTeamId> GetAllByTeamId(int teamId);
        ...
        Task<TeamByCharacterId> GetAllByCharacterId(int characterId);
        ...
        Task<Team_Character> CreateTeamCharacter(Team_Character teamChar);
        ...
        Task<Team_Character> GetTeamChar(int teamId, int characterId);
